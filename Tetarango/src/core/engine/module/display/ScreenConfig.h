...
namespace AW
{
	...
	public:
		...
		bool openGlWireframeMode = false, openGLCompatibilityMode = false, useDoubleBuffer = true, visualizeContainers = false, visualizeClipRects = false, debugOverlayEnabled = false;
