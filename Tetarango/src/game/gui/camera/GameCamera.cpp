...
namespace AWGame
{
	...
	void GameCamera::onGamepadAxisChanged(int gamepadIndex, MT::GamepadAxisMapping axis, double value)
	{
		switch (axis)
		{
		case MT::GamepadAxisMapping::RIGHT_X:
			xAxis = -value;
			break;

		case MT::GamepadAxisMapping::RIGHT_Y:
			yAxis = -value;
			break;
		}
	}
